...
TOKEN = "2107706777:AAGL4O89WiR2CGAGnnHPLJXp3TRGloqycl8"
    ...
    if "instagram.com" in instagram_post:
        ...
        try:
            ...
            bot.sendMessage(chat_id=update.message.chat_id,
                            text="Send Me Only Public Instagram Posts ⚡️")

        if checking_video == True:
            try:
                video_url = visit['graphql']['shortcode_media']['video_url']
                bot.send_chat_action(
                    chat_id=update.message.chat_id, action="upload_video")
            ...
            try:
                ...
                bot.send_chat_action(
                    chat_id=update.message.chat_id, action="upload_photo")
            ...
            bot.sendMessage(chat_id=update.message.chat_id,
                            text="I Cant Send You Private Posts :-( ")
    else:
        bot.sendMessage(chat_id=update.message.chat_id,
                        text="Kindly Send Me Public Instagram Video/Photo Url")
